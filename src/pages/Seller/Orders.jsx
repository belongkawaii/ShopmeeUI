            ...
            <table className="seller-table">
              ...
              <tbody>
                {orders.map((order) => {
                  ...
                  const paymentStatusLabel = getPaymentStatusText(order.payment_status);
                  ...
                  return (
                    <Fragment key={order.id}>
                      <tr style={{ borderBottom: "1px solid #e5e7eb" }}>
                        ...
                        <td>
                          <span style={{ fontSize: "12px", padding: "4px 8px", borderRadius: "6px", backgroundColor: order.payment_status === "paid" ? "#d1fae5" : "#fee2e2", color: order.payment_status === "paid" ? "#065f46" : "#991b1b", fontWeight: "500" }}>
